...
export const loader: LoaderFunction = async ({ request}) => {
  // if there is already session rediredt to home page
  ...
  const errors = {
    ...
    ...(action == 'register'
      ? {
        ...
        lasttName: validateName((lastName as string) || ''),
      }:{})
  }
    ...
    return (
        ...
        <FormField
          ...
          <div className="w-full text-center">
            ...
            <button type='submit' name='_action' value={action} className="rounded-xl mt-2 bg-yellow-300 px-3 py-2 text-blue-600 font-semibold transition duration-300 ease-in-out hover:bg-yellow-400 translate-y-1">
              {
